...
`composer require common-gateway/bag-bundle:dev-main` or dockerized: `docker-compose exec php composer require common-gateway/bag-bundle:dev-main`
...
`php bin/console commongateway:install common-gateway/bag-bundle` or dockerized: `docker-compose exec php bin/console commongateway:install common-gateway/bag-bundle`
